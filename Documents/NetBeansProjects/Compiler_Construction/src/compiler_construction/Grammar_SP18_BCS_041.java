...
public class Grammar_SP18_BCS_041 {

    private ArrayList<Rule_SP18_BCS_041> rules;
    private HashSet<String> terminals;
    /*values on the left side in a grammar also called non-terminals*/
...
B -> s
*/
    public Grammar_SP18_BCS_041(String s) {
        rules = new ArrayList<>();
        ...
        for(String st : s.split("\n")){
            ...
            for (String rule : rulesRightSide) {
                ...
                if (line == 0) {
                    ...
                    rules.add(new Rule_SP18_BCS_041("S'", new String[]{startVariable}));
                }
                
                rules.add(new Rule_SP18_BCS_041(leftSide, rightSide));
                line++;
            }
        }
    ...
    public ArrayList<Rule_SP18_BCS_041> getRules() {
        return rules;
    }
   
    public int findRuleIndex(Rule_SP18_BCS_041 rule){
        for(int i=0 ; i<rules.size();i++){
    ...
    private void computeFirstSets() {
        ...
        while (true) {
            ...
            for (String variable : variables) {
                ...
                for (Rule_SP18_BCS_041 rule : rules) {
    ...
    public HashSet<Rule_SP18_BCS_041> getRuledByLeftVariable(String variable) {
        HashSet<Rule_SP18_BCS_041> variableRules = new HashSet<>();
        for (Rule_SP18_BCS_041 rule : rules) {
            if (rule.getLeftSide().equals(variable)) {
    ...
    public boolean equals(Object obj) {
        ...
        final Grammar_SP18_BCS_041 other = (Grammar_SP18_BCS_041) obj;
